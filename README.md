# Virtual Sets and Enumerative Geometry: Building an open-source virtual mathematical kernel with Lean4 for solving enumerative geometry problems (proof not being dependent on complex numbers will be clarified soon ...)
